  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved colaborador as @colaborador" do
        ...
        post :create, {:colaborador => { "nombre" => "invalid value" }}, valid_session
        assigns(:colaborador).should be_a_new(Colaborador)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested colaborador" do
        ...
        Colaborador.any_instance.should_receive(:update).with({ "nombre" => "MyString" })
        put :update, {:id => colaborador.to_param, :colaborador => { "nombre" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the colaborador as @colaborador" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Colaborador.any_instance.stub(:save).and_return(false)
        put :update, {:id => colaborador.to_param, :colaborador => { "nombre" => "invalid value" }}, valid_session
        assigns(:colaborador).should eq(colaborador)
      end
