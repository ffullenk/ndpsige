  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved stock as @stock" do
        ...
        post :create, {:stock => { "articulo" => "invalid value" }}, valid_session
        assigns(:stock).should be_a_new(Stock)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested stock" do
        ...
        Stock.any_instance.should_receive(:update).with({ "articulo" => "" })
        put :update, {:id => stock.to_param, :stock => { "articulo" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the stock as @stock" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Stock.any_instance.stub(:save).and_return(false)
        put :update, {:id => stock.to_param, :stock => { "articulo" => "invalid value" }}, valid_session
        assigns(:stock).should eq(stock)
      end
